...
void TriangleWindow::render()
{
    ...
    matrix.scale(0.5f);
    matrix.rotate(500.0f * m_frame / screen()->refreshRate(), 1, 0, 0);
    matrix.rotate(500.0f * m_frame / screen()->refreshRate(), 0, 1, 0);
    matrix.rotate(500.0f * m_frame / screen()->refreshRate(), 0, 0, 1);
